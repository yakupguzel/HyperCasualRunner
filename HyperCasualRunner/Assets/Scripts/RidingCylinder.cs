...
public class RidingCylinder : MonoBehaviour
{
    ...
    public void IncrementCylinderVolume(float value)
    {
        ...
        if (_value > 1)
        {
            ...
            int cylinderCount = PlayerController.CurrentPlayer.cylinders.Count;
            // Silindirin boyutunu tam 1 yap
            ...
            // 1 den ne kadar büyük ise o büyüklükte silindir yap
            PlayerController.CurrentPlayer.CreateCylinder(leftValue);
        }
        else if (_value < 0)
        {
            // Current Player Silindiri yok etsin
            PlayerController.CurrentPlayer.DestroCylinder(this);
        }
        else
        {
